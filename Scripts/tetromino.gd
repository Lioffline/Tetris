...
@onready var S_move = get_tree().current_scene.get_node("SoundEffects/TetrominoMove")
...
func _input(event):
	if Input.is_action_pressed("left"):
		...
		hard_drop()
		get_tree().current_scene.get_node("SoundEffects/TetrominoDrop").play()
...
# Соприкосновение колизий тетромино
